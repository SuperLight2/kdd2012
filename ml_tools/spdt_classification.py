...
class SimpleClassifier:
    def __init__(self, discretization=8, alpha=0.9, min_object_in_node=-1, impurity_function=empirical_emtropy):
    ...
    def learn(self, features_filepath):
        ...
        while decision_tree.get_next_non_terminal_node() is not None:
            ...
            current_G = self.impurity_function(data, data_indexes)
            ...
            for feature_index, split_threshold in splits:
                ...
                left_G = self.impurity_function(data, left_indexes)
                right_G = self.impurity_function(data, right_indexes)
            ...
            left_child, right_child = decision_tree.split_node(current_node_index, best_feature_index, best_split_threshold)
            left_indexes = []
            right_indexes = []
            for index in data_indexes:
